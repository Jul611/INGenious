 ...
 */
public class MarketplaceManager extends JPanel {
    ...
    private final MarketplaceBrowseUI browseUI;
    ...
    private final MarketplaceConfig registryConfig = new MarketplaceConfig();

    /**
     * Creates the Marketplace window.
     *
     * @param mainFrame the parent AppMainFrame (can be null for standalone testing)
     */
    public MarketplaceManager(AppMainFrame mainFrame) {
        ...
        this.browseUI =
            new MarketplaceBrowseUI(service, reusableComponentService, this::refreshInstalled);
        ...
        this.installedUI =
            new PluginManagerInstalledUI(service, reusableComponentService, this::refreshInstalled);
        ...
        statusLabel = new JLabel("Marketplace");
        ...
        registrySettingsButton.addActionListener(
            e -> PluginRegistrySettingsDialog.show(MarketplaceManager.this, registryConfig)
        );
    ...
    public void load() {
        ...
        statusLabel.setText(
            "Marketplace | Plugins directory: " + PluginManagerService.getPluginsDirectory()
        );
    }
